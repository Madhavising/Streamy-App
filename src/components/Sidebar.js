...
const Sidebar = () => {
  ...
  return (
    <div className="border-r dark:border-none flex flex-col 2-[15rem] h-[calc(100vh-4.635rem)] overflow-y-scroll min-w-fit bg-white dark:bg-zinc-900 dark:text-white transition-all duration-500">
